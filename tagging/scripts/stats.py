...
class POSStats:
    ...
    def __init__(self, tagged_sents):
        ...
        #Create set of words and tags
        #This could be moved and only used in the functions that requires it
        #but since different functions uses it, I chose to leave it here and load it once 
        
        #Flatten the corpus
        self.flat_corpus = [tupla for sentence in self.corpus for tupla in sentence]
        #Then get words and tags
        self.corpus_words, self.corpus_tags = zip(*self.flat_corpus)   
...
#       return list(set(self.corpus_words))
    ...
    def tags(self):
        """POS Tagset."""
#       return list(set(self.corpus_tags))
    ...
    def tag_freq(self, t):
        """Frequency of tag t."""                   
        return self.corpus_tags.count(t) / self.tag_count()  
...
if __name__ == '__main__':
    ...
    # load the data
    corpus = SimpleAncoraCorpusReader(opts['<path>']) # opts -c returns boolean, path returns path
